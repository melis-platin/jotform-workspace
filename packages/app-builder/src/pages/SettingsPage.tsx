...
const PUSH_NOTIFICATION_HISTORY_FILTER_OPTIONS = [
  {
    value: 'all',
    label: 'See All',
    leading: <Icon name="eye-filled" category="general" size={24} className="push-notification-history__see-all-icon" />,
  },
  {
    value: 'sent',
    label: 'Sent',
...
export interface PushNotificationsPanelProps {
  ...
  onDisable: () => void
  onEnable: () => void
  onNotificationPreview?: (notification: PushNotificationHistoryItem) => void
...
interface PushNotificationHistoryCardProps {
  ...
  onPreview?: (notification: PushNotificationHistoryItem) => void
}

function PushNotificationHistoryCard({
  notification,
  appUserRoles,
  onEdit,
  onCancel,
